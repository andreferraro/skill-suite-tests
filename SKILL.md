...
- Para cancelamento ou reset, exercitar separadamente cada fase alcançável, como antes do callback assíncrono, durante uma operação pendente e entre lotes. Após liberar cada callback ou Promise obsoleta, afirmar tanto o estado final quanto a ausência de novos efeitos.
